...
// systemd restart to confirm the process is actually serving traffic — not
// just that systemd reports the unit "active". A 200 here means: Node is up,
// Next routing is wired, and the response body parses.
